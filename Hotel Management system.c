...
void intro()
 {
   printf("\n\t             Near Jamuna Future Park, Progoti Ave, Dhaka City,\n\t\t\t\t BANGLADESH");
   printf("\n\n                              Ph. No.:016-24556344");
   printf("\n\n\n                             WELCOMES YOU..............");
   printf("\n\n\n\tHotel JW Marriott is one of the newest Hotel in dhaka. The Hotel is \t\tequipped with with all the general amenities and facilities that go \t\talong with memorable stay. Set amidst beautifully landscaped gardens, \t\tit proves to be a ideal dream destination for perceptive traveller.");
   ...
   switch(typ)
     {
       ...
       printf("\n\n 3.TV available      ");
       printf("\n------------------------------------------------------------------");
       printf("\n NOTE :- Extra bed will cost TK.500 per bed ");
       break;
       case 2:
       screenheader();
       printf("\n Room number            >>>2\n\n");
...
void restaurant()
 {
   ...
   125,105,120,120,100};
   char food[113][50]={"SHAHI PANEER","KADAI PANEER","CHEESE KORMA",
